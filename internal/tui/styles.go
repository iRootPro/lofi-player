...
func NewStyles(t theme.Theme) Styles {
	...
	return Styles{
		...
		StationPlaying: lipgloss.NewStyle().Foreground(t.Secondary).Bold(true),
		...
		LogoMid:        lipgloss.NewStyle().Foreground(t.Secondary).Faint(true),
		LogoBase:       lipgloss.NewStyle().Foreground(t.Muted).Faint(true),
